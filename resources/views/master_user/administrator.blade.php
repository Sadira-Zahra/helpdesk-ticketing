...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Master Administrator</h1>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Data Administrator (Tanpa Departemen)</h3>
            ...
            <div class="card-body">
                ...
                <table id="tableAdministrator" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            <th width="5%">No</th>
                            <th width="8%">Foto</th>
    ...
    @endif
                            ...
                            <td>
                                <button type="button" class="btn btn-warning btn-sm" 
                                    onclick="editData({{ $user->id }}, '{{ $user->nik }}', '{{ $user->username }}', '{{ addslashes($user->nama) }}', '{{ $user->email }}', '{{ $user->no_telp }}')">
                                    <i class="fas fa-edit"></i>
                                </button>
                                <button type="button" class="btn btn-danger btn-sm" onclick="deleteData({{ $user->id }}, '{{ addslashes($user->nama) }}')">
...
<div class="modal fade" id="modalTambah" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form action="{{ route('master_user.administrator.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
...
function editData(id, nik, username, nama, email, no_telp) {
    let url = "{{ route('master_user.administrator.update', ':id') }}";
...
function deleteData(id, nama) {
    if (confirm('Apakah Anda yakin ingin menghapus administrator ' + nama + '?')) {
        let url = "{{ route('master_user.administrator.destroy', ':id') }}";
        url = url.replace(':id', id);
