...
class TeknisiController extends Controller
{
    public function index()
    {
        ...
        return view('master_user.teknisi', compact('users', 'departemens'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if (!in_array($departemen->nama_departemen, ['IT', 'GA', 'EHS'])) {
            return back()->with('error', 'Teknisi hanya bisa dari departemen IT, GA, atau EHS');
        }
        ...
        return redirect()->route('master_user.teknisi.index')
